...
function install(){
 ...
 // Brescia mobile: remove the explicit marker-centering pan from the selection path.
 // Leaflet opens the popup and owns the pan needed to keep the complete popup visible.
