...
// Statistics/tooltips are kept in a separate enhancement so the universal baseline remains easy to roll back.
(function(){
  if(document.querySelector('script[data-fuorisede-stats]'))return;
  const script=document.createElement('script');
  script.src='/stats-tooltips.js?v=20260922-1';
  script.dataset.fuorisedeStats='1';
